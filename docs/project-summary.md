...
In-app permission roles: **Admin**, **Analyst**, **Manager**, **Viewer** — see [`docs/requirements/fleet_operations_spec.md`](requirements/fleet_operations_spec.md) §6.6 for the matrix.
...
- [Fleet operations interactive prototype](requirements/fleet_mockup.html) — open in a browser to interact with the live HTML rendering. 3 top-level screens (Auth / Dashboard / Research), 9 widgets, 11 research tools, 3 dashboard demo-states.
