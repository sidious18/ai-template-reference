...
- _Empty_ — bare grid, ready for selection.
- _Selecting_ — pre-drawn 4 × 3 selection with the widget picker open.
- _Configured_ — fully populated default layout with nine widgets.
