...
Read `ai-instructions/commands/tmpl-reconfigure.md` from the project root and
follow every step in order.

`/tmpl-reconfigure` is the lightweight counterpart to `/tmpl-setup` — it lets you
...
(e.g., `/tmpl-reconfigure add a Mobile Developer role`), use it as the starting
